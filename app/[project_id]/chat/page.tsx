...
const hexToFilter = (hex: string): string => {
  ...
  const filters: { [key: string]: string } = {
    '#2BB3E6': 'brightness(0) saturate(100%) invert(40%) sepia(86%) saturate(1806%) hue-rotate(201deg) brightness(98%) contrast(98%)',
  ...
  return filters[hex] || filters['#2BB3E6'];
};
          ...
          >
            ...
            <div className="p-4 rounded-bl-2xl">
              <ChatInput
                ...
                disabled={isRunning}
                placeholder={mode === 'act' ? "Ask CognitXable..." : "Chat with CognitXable..."}
                mode={mode}
